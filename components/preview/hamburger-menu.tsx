...
export const HamburgerMenu = () => {
  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      >
        <div className="relative px-2.5 py-2 rounded-lg overflow-hidden group">
          {/* Gradient Background */}
          ...
          {/* Border */}
          <div className="absolute inset-0 rounded-lg border border-black/[0.08]" />
      ...
      >
        <div className="relative px-2.5 py-2 rounded-lg overflow-hidden group shadow-sm">
          {/* Gradient Background */}
          <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent" />
          ...
          {/* Highlight */}
          <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-b from-white/10 to-transparent" />
        </div>
      </button>
      ...
      >
        <div className="relative px-2.5 py-2 rounded-lg overflow-hidden group shadow-sm">
          ...
          {/* Icon - Replace with actual image */}
