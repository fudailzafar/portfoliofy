 ...
 *
 * NOTE: Components wrapped with withInteractable() are automatically registered
 * and should NOT be added to this array to avoid conflicts.
 *
 ...
 */
export const components: TamboComponent[] = [
  // InteractablePortfolio is registered via withInteractable() HOC
  // and should not be added here to avoid tool conflicts
];
