...
export const HamburgerMenu = () => {
  ...
  return (
    <div className="flex items-center gap-1">
      {/* Link Button */}
      <button
        className="relative h-[33px] w-[33px] rounded-md transition-all active:scale-95 group"
      ...
      >
        ...
        <div className="absolute inset-0 rounded-md border border-black/[0.08]" />
        <div className="absolute inset-0 rounded-md opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-b from-white/20 to-transparent" />
      </button>

      {/* Image Button */}
      <button
        className="relative h-[33px] w-[33px] rounded-md transition-all active:scale-95 group shadow-[0px_1px_2px_rgba(0,0,0,0.05)]"
        aria-label="Add Image"
      >
        <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent rounded-md" />
        <div className="relative h-full w-full flex items-center justify-center overflow-hidden rounded-md">
          <img src="/image.png" alt="" width={24} height={24} className="relative z-10" />
        </div>
        <div className="absolute inset-0 rounded-md border border-black/[0.08]" />
        <div className="absolute inset-0 rounded-md opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-b from-white/10 to-transparent" />
      </button>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent rounded-md" />
        <div className="relative h-full w-full flex items-center justify-center overflow-hidden rounded-md">
          <img src="/text.png" alt="" width={24} height={24} className="relative z-10" />
        </div>
        <div className="absolute inset-0 rounded-md border border-black/[0.08]" />
        <div className="absolute inset-0 rounded-md opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-b from-white/10 to-transparent" />
      </button>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent rounded-md" />
        <div className="relative h-full w-full flex items-center justify-center overflow-hidden rounded-md">
          <img src="/map.png" alt="" width={24} height={24} className="relative z-10" />
        </div>
        <div className="absolute inset-0 rounded-md border border-black/[0.08]" />
        <div className="absolute inset-0 rounded-md opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-b from-white/10 to-transparent" />
      </button>
