...
export const metadata: Metadata = {
  ...
  description:
    'Read our terms and conditions for using Portfoliofy. Learn about user agreements, service usage, and legal guidelines.',
  openGraph: {
    title: 'Terms of Service | Portfoliofy',
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-lg bg-white p-8 shadow-xl">
          ...
          <h3 className="mb-2 text-xl font-medium text-gray-700">Waiver</h3>
          <p className="mb-8 text-gray-700">
