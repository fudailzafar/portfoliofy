...
export const metadata: Metadata = {
  ...
  description:
    'Learn how Portfoliofy collects, uses, and protects your personal data. Read our comprehensive privacy policy and data protection guidelines.',
  openGraph: {
    title: 'Privacy Policy | Portfoliofy',
    description:
      'Learn how Portfoliofy protects your personal data and privacy.',
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-lg bg-white p-8 shadow-xl">
          ...
          <ul className="mb-8 list-inside list-disc space-y-4 text-gray-700">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                Portfoliofy, accessible from
                <a
                  href="https://www.portfoliofy.me"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="text-blue-600 hover:underline"
                >
                  https://www.portfoliofy.me
                </a>
              </p>
            </li>
            <li>
          ...
          <h4 className="mb-2 text-lg font-medium text-gray-700">Usage Data</h4>
          <p className="mb-4 text-gray-700">
          ...
          <ul className="mb-4 list-inside list-disc space-y-4 text-gray-700">
            <li>
              <strong className="font-semibold">
